			...
			<div class="container-md py-3 px-xl-5 my-5 mb-lg-0">	
				<div class="card">
					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-12 col-lg-9 py-0" style="max-height: 60vh; overflow-y: auto;">
								<form id="FormularioRepresentante" action="test.php" method="POST">
									...
									<section id="seccion1" class="row my-2">
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-5">
												<input 
													...
													title="Debe ingresar solo letras" 
													required
												>
											</div>
											<!-- Segundo nombre -->
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-8">
												...
												<input 
													...
													minlength="3" 
													maxlength="15" 
													placeholder="Madre, padre, tíos o abuelos, etc." 
													required
												>
											</div>
										</div>
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-4">
												<input 
													id="Código_Carnet_Patria_R" 
													class="mb-2 form-control" 
													type="text" 
													name="Código_Carnet_Patria_R" 
													placeholder="Código" 
													pattern="[0-9]+" 
													minlength="10"
													maxlength="10"
									...
									<section id="seccion2" class="row my-2" style="display:none;">
										...
										<div class="row mb-4">
											<div class="col-12 col-lg-12">
												<span class="h5">
													<i class="fa-solid fa-address-book fa-lg me-2"></i>
													Datos de contacto
												</span>
											</div>
										</div>
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-10">
												<div class="input-group mb-2 mb-2">
													<input 
														...
														class="mb-2 form-control mb-2 form-control-sm" 
														type="text" 
													...
													>
													<input 
														id="Teléfono_Principal_R" 
														class="mb-2 form-control mb-2 form-control-sm w-auto" 
														type="tel" 
														name="Teléfono_Principal_R" 
														placeholder="Número" 
														pattern="[0-9]+" 
														maxlength="12" 
														minlength="7" 
											...
											<div class="col-12 col-lg-10">
												<div class="input-group mb-2 mb-2">
													...
													>
													<input 
														id="Teléfono_Secundario_R" 
														class="mb-2 form-control mb-2 form-control-sm w-auto" 
														type="tel" 
														name="Teléfono_Secundario_R" 
														placeholder="Número" 
														pattern="[0-9]+" 
														maxlength="12" 
														minlength="7"
											...
											<div class="col-12 col-lg-10">
												<div class="input-group mb-2 mb-2">
													...
													>
													<input 
														id="Teléfono_Auxiliar_R" 
														class="mb-2 form-control mb-2 form-control-sm w-auto" 
														type="tel" 
														name="Teléfono_Auxiliar_R" 
														placeholder="Número" 
														pattern="[0-9]+" 
														maxlength="12" 
														minlength="7"
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-9">
												<input 
													id="Correo_electrónico_R" 
													class="mb-2 form-control" 
													type="email" 
													name="Correo_electrónico_R" 
													minlength="15" 
													required
												>
											</div>
									...
									<section id="seccion3" class="row my-2" style="display:none;">
										...
										<div class="row mb-4">
											<div class="col-12 col-lg-12">
												<span class="h5">
													<i class="fa-solid fa-house-circle-check fa-lg me-2"></i>
													Datos de vivienda
												</span>
											</div>
										</div>
									...
									<section id="seccion4" class="row my-2" style="display:none;">
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-9">
												<input 
													...
													pattern="[0-9]{20}" 
													maxlength="20" 
													title="Una cuenta bancaria valida consta de 20 digitos" 
													placeholder="XXXX-XXXXXXXXXXXXXX" 
													required
												>
											</div>
											<!-- Información adicional -->
										...
										<div class="row mb-4">
											<div class="col-12 col-lg-12">
												<span class="h5">
													<i class="fa-solid fa-piggy-bank fa-lg me-2"></i>
													Datos laborales
												</span>
											</div>
										</div>
											...
											<div class="row mb-4">
												...
												<div class="col-12 col-lg-9">
													<div class="input-group mb-2">
														...
														>
														<input 
															id="Teléfono_Trabajo_R" 
															class="mb-2 form-control mb-2 form-control-sm w-auto" 
															type="tel" 
															name="Teléfono_Trabajo_R" 
															placeholder="Número" 
															pattern="[0-9]+" 
															maxlength="12" 
															minlength="7"
									...
									<section id="seccion5" class="row my-2" style="display:none;">
										...
										<div class="row mb-4">
											<div class="col-12 col-lg-12">
												<span class="h5">
													<i class="fa-solid fa-handshake-angle fa-lg me-2"></i>
													Contacto auxiliar
												</span>
											</div>
										</div>
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-10">
												<div class="input-group mb-2">
													...
													>
													<input 
														id="Télefono_Principal_Aux" 
														class="mb-2 form-control mb-2 form-control-sm w-auto" 
														type="tel" 
														name="Teléfono_Principal_Aux" 
														placeholder="Número" 
														maxlength="7" 
														minlength="7" 
														required
										...
										<div class="row mb-4">
											...
											<div class="col-12 col-lg-8">
												<input 
													id="Relación_Auxiliar" 
													class="mb-2 form-control" 
													type="text" 
													name="Relación_Auxiliar" 
					...
					<div class="card-footer">
						...
						<button id="B_enviar_1" class="btn btn-primary" type="button">Guardar y continuar</button>
					</div>
				</div>
