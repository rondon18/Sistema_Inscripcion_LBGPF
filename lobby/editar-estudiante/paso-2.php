					...
					<div>
						...
						<div>
							...
							<div class="input-group mb-2">
								...
								<input class="form-control w-auto" type="text" name="País_Ma" id="País_Ma" placeholder="¿Donde?" value="<?php if($madre['País_Residencia'] != "Venezuela"){echo $madre['País_Residencia'];} ?>"
