...
require('../clases/alumnos-repitentes.php');
...
$alumno_repitente = $Alumno_repitente->consultarAlumnosRepitentes($_POST['id_alumno']);
$grado = $Grado->consultarGrado($_POST['id_alumno']);
...
<body>
	...
	<form class="card" action="../controladores/control-alumnos.php" method="POST" style="max-width: 600px; margin: 75px auto;">
			...
			<div>
				...
				<div>
					...
					<div>
						...
						<div class="input-group">
							<input class="form-control mb-2" type="text" name="Primer_Nombre_Alumno" placeholder="Primer nombre" required value="<?php echo $nombres_alumno[0] ?>">
							<input class="form-control mb-2" type="text" name="Segundo_Nombre_Alumno" placeholder="Segundo nombre" required value="<?php echo $nombres_alumno[1] ?>">
						</div>
					...
					<div>
						...
						<div class="input-group">			
							<input class="form-control mb-2" type="text" name="Primer_Apellido_Alumno" placeholder="Primer apellido" required value="<?php echo $apellidos_alumno[0] ?>">
							<input class="form-control mb-2" type="text" name="Segundo_Apellido_Alumno" placeholder="Segundo apellido" required value="<?php echo $apellidos_alumno[1] ?>">
						</div>			
					</div>
					
					<div>
						<label >Cédula:</label>
						<input class="form-control mb-2" type="text" name="Cedula_Alumno" placeholder="Cédula de identidad" required value="<?php echo $alumno['Cédula'] ?>">
					</div>
					<div>
						<span>Genero:</span>
						...
						<div class="form-check">
							...
							<input class="form-check-input" type="radio" name="Genero_Alumno" value="F" required <?php if ($alumno['Género'] == "F") { echo "checked";} ?>>
						</div>
						<div class="form-check">
							<label class="form-label">M </label>
							<input class="form-check-input" type="radio" name="Genero_Alumno" value="M" required <?php if ($alumno['Género'] == "M") { echo "checked";} ?>>
						</div>
					...
					<div>
						...
						<input class="form-control mb-2" type="date" name="Fecha_Nacimiento_Alumno" required value="<?php echo $alumno['Fecha_Nacimiento'] ?>" required value="<?php echo $alumno['Fecha_Nacimiento'] ?>">
					</div>
					<div>
						<label class="form-label">Lugar de nacimiento:</label>
						<input class="form-control mb-2" type="text" name="Lugar_Nacimiento_Alumno" value="<?php echo $alumno['Lugar_Nacimiento'] ?>">
					</div>
					<div>
						<label class="form-label">Correo electrónico:</label>
						<input class="form-control mb-2" type="text" name="Correo_electrónico_Alumno" required value="<?php echo $alumno['Correo_Electronico'] ?>">
					</div>
					<div>
						<label >Teléfono principal:</label>
						<input class="form-control mb-2" type="tel" name="Teléfono_Principal_Alumno" placeholder="Movil" required value="<?php echo $alumno['Teléfono_Principal'] ?>">
						<label >Teléfono auxiliar:</label>
						<input class="form-control mb-2" type="tel" name="Teléfono_Auxiliar_Alumno" placeholder="Fijo" required value="<?php echo $alumno['Teléfono_Auxiliar'] ?>">
					</div>
					<div>
					...
					<div>
						...
						<div class="form-check">
							...
							<input class="form-check-input" type="radio" name="Tiene_Materias_Pendientes" value="Si" required <?php if (!empty($alumno['Lugar_Nacimiento'])) {	echo "checked";} ?>>
						</div>
						<div class="form-check">
							<label class="form-label">No </label>
							<input class="form-check-input" type="radio" name="Tiene_Materias_Pendientes" value="No" required <?php if (empty($alumno['Lugar_Nacimiento'])) {	echo "checked";} ?>>
						</div>
						<span>¿Cuales?</span>
						<input class="form-control mb-2" type="text" name="Materias_Pendientes" required value="<?php echo $alumno_repitente["Materias_Pendientes"] ?>">
					</div>
					
					<div>
						<label class="form-label">Plantel de procedencia:</label>
						<textarea class="form-control mb-2" name="Plantel_Procedencia"><?php echo $alumno['Plantel_Procedencia'] ?></textarea class="form-control mb-2">
					</div>
				...
				<div>
					...
					<div>
						...
						<textarea class="form-control mb-2" name="Direccion_Alumno"><?php echo $alumno['Dirección'] ?></textarea class="form-control mb-2">
					</div>
					<div>
