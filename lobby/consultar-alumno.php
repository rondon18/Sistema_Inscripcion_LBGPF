...
<body>
	...
	<div style="width: 80%; margin: auto; max-height: 85vh; overflow-y: auto;">
		...
		<table id="alumno" class="table table-bordered">
			<thead>
				<th colspan="4">Datos de inscripción del alumno</th>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					<td>Plantel_Procedencia: <?php echo $alumno['Plantel_Procedencia']?></td>
			...
			<tr>
				<td>
					...
					<form action="editar-alumno.php" method="POST">
						<input type="hidden" name="id_alumno" value="<?php echo $alumno['idAlumnos'];?>">
						<input type="hidden" name="id_representante" value="<?php echo $alumno['idRepresentante'];?>">
						<input type="hidden" name="id_padre" value="<?php echo $alumno['idPadre'];?>">
					
						<input class="btn btn-primary" type="submit" name="Editar alumno" value="Editar alumno">
					</form>
					<?php endif ?>
				</td>
				<td>
					<form action="../controladores/control-alumnos.php" method="POST">
						...
						<input class="btn btn-primary" type="submit" name="Eliminar alumno" value="Eliminar alumno">
					</form>
				</td>
				<td>
