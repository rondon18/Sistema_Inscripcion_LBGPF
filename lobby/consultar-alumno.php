...
<body>
	...
	<div style="width: 100%; max-height: 85vh; overflow-y: auto;">
		...
		<tr>
			<td>
				<form action="editar-alumno.php" method="POST">
					...
					<input type="submit" name="Editar alumno" value="Editar alumno">
				</form>
			</td>
			<td>
				<form action="../controladores/control-alumnos.php" method="POST">
					...
					<input type="submit" name="Eliminar alumno" value="Eliminar alumno">
				</form>
			</td>
			<td>
