								...
								<div class="col p-4">
									<div class="card">
										<div class="card-header">
											<span class="card-title">Gestionar registros</span>
										</div>
										<div class="card-body">
											<p class="card-text small">Consultar y gestionar registros de estudiantes.</p>
										</div>
										<div class="card-footer">
											<a href="#" class="btn btn-primary btn-block btn-sm stretched-link">Visitar sección</a>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="col-12 col-md-6 col-lg-4 col-xl-4 d-flex p-2">
											<div
												...
												<p class="ps-2 m-0 my-1 w-100">
													...
													<a href="registrar_estudiante/paso_1.php" class="d-block btn btn-sm btn-outline-light mt-2 mb-0 hvr-icon">
														Registrar nuevo
										...
										<div class="col-12 col-md-6 col-lg-4 col-xl-4 d-flex p-2">
											<div
												...
												<p class="ps-2 m-0 my-1 w-100">
													...
													<a href="registrar_usuario/index.php" class="d-block btn btn-sm btn-outline-light mt-2 mb-0 hvr-icon">
														Registrar nuevo
														<i class="fas fa-plus-square fa-lg ms-1 hvr-icon"></i>
													</a>
												</p>
