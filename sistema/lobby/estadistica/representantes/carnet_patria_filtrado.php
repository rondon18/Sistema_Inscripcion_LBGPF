			...
			<div class="row">
				...
				<div class="col-12">
					...
					<table class="table table-sm table-bordered table-striped table-responsive">
						...
						<tbody>
							<tr>
								<td><?php echo $representantes->get_nro_r_c_carnet_p($anio,$seccion);?></td>
								<td><?php echo $representantes->get_nro_representantes($anio,$seccion) - $representantes->get_nro_r_c_carnet_p($anio,$seccion);?></td>
			  ...
			  new Chart(carnet_patria, {
			    ...
			    data: {
			      datasets: [{
			        ...
			        data: [
			        	<?php echo $representantes->get_nro_r_c_carnet_p($anio,$seccion);?>,
			        	<?php echo $representantes->get_nro_representantes($anio,$seccion) - $representantes->get_nro_r_c_carnet_p($anio,$seccion);?>,
			      	],
			        borderWidth: 1
			      }]
			    },
