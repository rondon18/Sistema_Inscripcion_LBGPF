...
<div class="col-md-6 p-2 my-4">
	<div class="card">
		<div class="card-header">
			<p class="h6">Padre que cuentan con carnet de la patria</p>
		</div>
		<div class="card-body">
			<!-- Estudiantes por género (general) -->
			<div class="row">
				...
				<div class="col-12">
					...
					<table class="table table-sm table-bordered table-striped table-responsive">
						...
						<tbody>
							<tr>
								<td><?php echo $padre->get_nro_p_c_carnet_p();?></td>
								<td><?php echo $padre->get_nro_padres() - $padre->get_nro_p_c_carnet_p();?></td>
								<td><?php echo $padre->get_nro_padres();?></td>
							</tr>
						</tbody>
						<tbody>
					</table>
			  ...
			  new Chart(carnet_patria, {
			    ...
			    data: {
			      datasets: [{
			        label: 'Nro. de padre',
			        data: [
			        	<?php echo $padre->get_nro_p_c_carnet_p();?>,
			        	<?php echo $padre->get_nro_padres() - $padre->get_nro_p_c_carnet_p();?>,
			      	],
			        borderWidth: 1
			      }]
			    },
