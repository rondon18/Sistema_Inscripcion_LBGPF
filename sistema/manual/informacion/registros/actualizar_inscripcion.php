...
<section class="row row-cols-1">
	...
	<h1>Registros</h1>
  <p class="lead">Proceso de actualización de datos de inscripción de un estudiante</p>
	...
	<div class="px-3">
		...
		<p>
			Para acceder a este módulo, deberá acceder al módulo de consulta de estudiantes, una vez ahí, debe seleccionar el registro de estudiante a editar, se desplegará un menú con las distintas opciones disponibles, entre estas debe presionar editar.
		</p>

		<p>
			Al ingresar a esta pantalla se comenzará el actualización de datos de inscripción de un estudiante, el cual consta de tres secciones principales: representantes, padres y estudiantes; cada una de estos cuenta con secciones propias, las cuales se describen a continuación.
		</p>
