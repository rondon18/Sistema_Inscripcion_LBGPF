...
CREATE TABLE `datos-laborales` (
  ...
  `Remuneración_R` varchar(45) DEFAULT NULL,
  `Tipo_Remuneración_R` varchar(45) DEFAULT NULL,
  `idRepresentantes` int(11) NOT NULL,
...
CREATE TABLE `datos-vivienda` (
  ...
  `Tipo_Vivienda_R` varchar(25) NOT NULL,
  `Tenencia_vivienda_R` varchar(25) NOT NULL,
...
-- Dump completed on 2022-05-19 18:26:54
