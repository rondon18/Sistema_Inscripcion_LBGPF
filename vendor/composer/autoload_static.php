...
class ComposerStaticInitda2225a48a20f962c6ba6b3d0487576a
{
    ...
    public static $classMap = array (
        ...
        'antropometria_est' => __DIR__ . '/../..' . '/sistema/clases/antropometria_est.php',
        'bitacora' => __DIR__ . '/../..' . '/sistema/clases/bitacora.php',
        'carnet_patria' => __DIR__ . '/../..' . '/sistema/clases/carnet_patria.php',
        'condiciones_est' => __DIR__ . '/../..' . '/sistema/clases/condiciones_est.php',
        'contactos_aux' => __DIR__ . '/../..' . '/sistema/clases/contactos_aux.php',
        'datos_academicos' => __DIR__ . '/../..' . '/sistema/clases/datos_academicos.php',
        'datos_economicos' => __DIR__ . '/../..' . '/sistema/clases/datos_economicos.php',
        'datos_laborales' => __DIR__ . '/../..' . '/sistema/clases/datos_laborales.php',
        'datos_salud' => __DIR__ . '/../..' . '/sistema/clases/datos_salud.php',
        'datos_sociales' => __DIR__ . '/../..' . '/sistema/clases/datos_sociales.php',
        'datos_vivienda' => __DIR__ . '/../..' . '/sistema/clases/datos_vivienda.php',
        'direcciones' => __DIR__ . '/../..' . '/sistema/clases/direcciones.php',
        'estudiantes' => __DIR__ . '/../..' . '/sistema/clases/estudiantes.php',
        'grado_a_cursar_est' => __DIR__ . '/../..' . '/sistema/clases/grado_a_cursar_est.php',
        'inscripciones' => __DIR__ . '/../..' . '/sistema/clases/inscripciones.php',
        'mantenimiento' => __DIR__ . '/../..' . '/sistema/clases/mantenimiento.php',
        'observaciones_est' => __DIR__ . '/../..' . '/sistema/clases/observaciones_est.php',
        'padres' => __DIR__ . '/../..' . '/sistema/clases/padres.php',
        'per_academico' => __DIR__ . '/../..' . '/sistema/clases/per_academico.php',
        'personas' => __DIR__ . '/../..' . '/sistema/clases/personas.php',
        'representantes' => __DIR__ . '/../..' . '/sistema/clases/representantes.php',
        'tallas_est' => __DIR__ . '/../..' . '/sistema/clases/tallas_est.php',
        'telefonos' => __DIR__ . '/../..' . '/sistema/clases/telefonos.php',
        'usuarios' => __DIR__ . '/../..' . '/sistema/clases/usuarios.php',
        'vac_covid19_est' => __DIR__ . '/../..' . '/sistema/clases/vac_covid19_est.php',
        'vacunas_est' => __DIR__ . '/../..' . '/sistema/clases/vacunas_est.php',
    );

    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitda2225a48a20f962c6ba6b3d0487576a::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitda2225a48a20f962c6ba6b3d0487576a::$prefixDirsPsr4;
            $loader->prefixesPsr0 = ComposerStaticInitda2225a48a20f962c6ba6b3d0487576a::$prefixesPsr0;
            $loader->classMap = ComposerStaticInitda2225a48a20f962c6ba6b3d0487576a::$classMap;
