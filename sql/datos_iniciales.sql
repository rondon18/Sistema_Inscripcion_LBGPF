...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`usuarios` (
  ...
  INDEX `fk_usuarios_personas1_idx` (`cedula_persona` ASC),
  PRIMARY KEY (`cedula_persona`),
  UNIQUE INDEX `cedula_persona_UNIQUE` (`cedula_persona` ASC),
...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`datos_economicos` (
  ...
  UNIQUE INDEX `cedula_representante_UNIQUE` (`cedula_representante` ASC),
...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`estudiantes` (
  ...
  INDEX `fk_estudiantes_padres1_idx` (`cedula_padre` ASC),
  INDEX `fk_estudiantes_padres2_idx` (`cedula_madre` ASC),
  INDEX `fk_estudiantes_personas1_idx` (`cedula_persona` ASC),
  INDEX `fk_estudiantes_representantes1_idx` (`cedula_representante` ASC),
  UNIQUE INDEX `cedula_persona_UNIQUE` (`cedula_persona` ASC),
...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`observaciones_est` (
  ...
  UNIQUE INDEX `cedula_estudiante_UNIQUE` (`cedula_estudiante` ASC),
...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`grado_a_cursar_est` (
  ...
  `cedula_estudiante` VARCHAR(45) NOT NULL,
  `id_per_academico` INT NOT NULL,
  PRIMARY KEY (`cedula_estudiante`, `id_per_academico`),
  INDEX `fk_grado_a_cursar_est_per_academico1_idx` (`id_per_academico` ASC),
...
CREATE TABLE IF NOT EXISTS `base_proyecto_nueva`.`inscripciones` (
  ...
  INDEX `fk_inscripciones_usuarios1_idx` (`cedula_usuario` ASC),
  INDEX `fk_inscripciones_estudiantes1_idx` (`cedula_estudiante` ASC),
